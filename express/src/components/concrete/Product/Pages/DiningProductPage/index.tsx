...
// Data
import { adminInfo, amenities, assetTags, capacityRange, exclusiveOffer, images, info, name, opening, location, menu, pricePackages, prices, rating, reviews } from '@src/data/product/dining';
import { types } from '@src/data/product/diningSidebar';
...
export default useRoom(DiningProductPage);
