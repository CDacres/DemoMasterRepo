...
// Data
import { adminInfo, amenities, assetTags, capacityRange, exclusiveOffer, images, info, location, menu, name, opening, pricePackages, prices, rating, reviews } from '@src/data/product/party';
import { types } from '@src/data/product/partySidebar';
...
export default useRoom(PartyProductPage);
