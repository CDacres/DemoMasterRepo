...
const MapBoxMap: React.FunctionComponent<Props> = ({ closeMapModal, height, lat, lon, openMapModal, showMapModal, showMarker, width, zoom }) => {
  // let path = '';
  // let path = 'path-5+f44-0.5+f44-0.2(wfkyH~hYtYj_Ajh@uu@iPal@kXuWmX`{@)'; TODO: example make it circle
  const mapUrl = `//api.mapbox.com/styles/v1/mapbox/streets-v11/static/${lon},${lat},${zoom},0,0/${width}x${height}?access_token=${process.env.MAPBOX_API_KEY}`;
