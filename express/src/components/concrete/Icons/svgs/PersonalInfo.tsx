...
const PersonalInfo = ({ isSmall, stylesArray, viewBox }: Props) => (
  <SvgIcon
    style={{
      height: '32px',
      width: '32px',
    ...
    viewBox={viewBox}
  >
    <path d="m18.66 6.51-14.84 9.65a1 1 0 0 0 .55 1.84h15.62a1 1 0 0 0 1-1v-9.24a1.5 1.5 0 0 0 -2.32-1.26z" />
    <path
