...
describe('filteredReducer Tests', () => {
  ...
  const testCases = [
    {
      name: 'combined',
      reducer: () => combineReducers({ primitive, plainObject }),
      initialState: { primitive: 1, plainObject: { test: 'other' } },
      expectedState1: { primitive: 0, plainObject: { test: 'value' } },
      expectedState2: { primitive: 0, plainObject: { test: 'value' } },
      expectedState3: { primitive: 1, plainObject: { test: 'other' } },
      expectedState4: { primitive: 1, plainObject: { test: 'other' } }
    },
    {
      name: 'primitive',
      reducer: () => primitive,
