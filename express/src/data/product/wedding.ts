...
export const adminInfo = {
  agree_to_list: true,
  website: 'https://www.rmg.co.uk/work-services/weddings-venue-hire/venues',
  first_name: 'Events',
  last_name: 'Team',
  email: 'events@rmg.co.uk',
  phone: '+44 20 8312 8517',
};
...
export const images = {
  main: 'https://www.rmg.co.uk/sites/default/files/styles/rmg_landscape_medium/public/Page%204-5%20Great%20Hall%20couple.jpg',
  secondary: 'https://abac7c57c1374ed95f4b-fc517bfeb78f64bd2cb175c56cdcead7.ssl.cf3.rackcdn.com//214377/870_450_03ad61d97b0c2b7d356acdad7ff53624.jpg',
  tertiary: 'https://abac7c57c1374ed95f4b-fc517bfeb78f64bd2cb175c56cdcead7.ssl.cf3.rackcdn.com//214377/870_450_7d6b9df607f27997eb5420d9e8a9dc06.jpg',
};

export const info = {
  description: "In The Queen's House, The Great Hall is an ideal setting for dinner parties and exclusive suppers. A perfect 40-foot cube, with its original black and white marble floor and a large vaulted ceiling decorated with gold leaf, the hall offers fine views of the River Thames and the Old Royal Naval College. To finish in style, guests and watch fireworks from the terrace.",
  owner_first_name: 'Events',
  owner_last_name: 'Lastname',
  response_rate: '99',
  response_time: 'room.within_an_hour',
  venue_city: 'London',
  venue_name: "Queen's House",
  vertical_id: 5,
};
...
export const name = "Queen's House";
...
export const pricePackages = [
  {
    extras: {
      ...
      description: "The Great Hall of The Queen's House is a stunning space with a large vaulted ceiling and a 400 year old black and white marble floor. The space is perfect for larger lunches and presentations or panel discussions. With the abundance of green space there are also opportunities for outdoor drinks receptions and evening soirees following daytime hire.",
      pictures: [
