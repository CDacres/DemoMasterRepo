import { Catalog, DayOfWeek, DayOfWeekItem } from '@src/core';

const _itemsSource: DayOfWeekItem[] = [
  {
    ddd: 'common.mon',
...
export const dayOfWeekCatalog = new Catalog<DayOfWeekItem>().withItems(_itemsSource);
