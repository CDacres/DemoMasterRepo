                                ...
                                <span style="color:#484848;">
                                    <span style="font-size:18px; line-height:1.4;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            ...
                                            <br>
                                            <br>
                                            La réservation confirmée pour l'espace "<?php echo $room_name;?>" (<?php echo $checkin;?> <?php echo $time_in;?> - <?php echo $checkout;?> <?php echo $time_out;?>) a été annulée par <?php echo $host_name;?>. Votre paiement vous sera remboursé.
                                            <br>
                                            <br>
