                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            <strong>
                                                <span style="color:#484848;">Hurra - Ihre Reservierungsanfrage wurde angenommen!</span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="color:#484848;">
                                    <span style="font-size:18px; line-height:1.4;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            ...
                                            <br>
                                            <br>
                                            Reservierung angenommen <?php echo $venue_name;?>
                                            <br>
                                            <br>
                                            <?php echo $comment;?>
                                            <br>
                                            <br>
                                            Bitte überprüfen Sie alle Details zu Ihrer Reservierung und sagen Sie uns <?php echo $host_name;?> falls Sie etwas klären möchten.
                                            <br>
                                            <br>
                                            Falls Sie eine Rechnungbenötigen bitte klicken Sie auf <a href="<?php echo $message_request_link . $analytics_str;?>">den folgenden Link</a>, wählen Sie 'Rechnung Drucken' und speichern Sie das Dokument. Wir verweisen Sie darauf hin, dass nicht jeder Anbieter eine MwSt-Rechnung zur Verfügung stellen kann.
                                            <br>
                                            <br>
                                            Rechnungen vom Anbieter, die direkt an Sie adressiert worden sind, wurden höchstwahrscheinlich aus Versehen gesendet und können ignoriert werden. Bitte, achten Sie darauf dass Ihr Raum über Zipcube reserviert, bezahlt und gesichert wird, daher müssen alle Änderungen oder Stornierungen durch Zipcube vorgenommen werden.
                                            <br>
                                            <br>
                                ...
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            <strong>
                                                <span style="color:#484848;">Teilen Sie Ihre Buchungsdetails mit den anderen Teilnehmern.</span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
