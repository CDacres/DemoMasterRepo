                                ...
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            <strong>
                                                <span style="color:#484848;">Reservierungsanfrage wurde abgelehnt vom Kunden</span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="color:#484848;">
                                    <span style="font-size:18px; line-height:1.4;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            ...
                                            <br>
                                            <br>
                                            Folgende Reservierungsanfrage für <?php echo $venue_name;?> wurde abgelehnt vom Kunden.
                                        </span>
                                    </span>
                                </span>
                                <br>
