                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            <strong>
                                                <span style="color:#484848;">Booking request declined!</span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="color:#484848;">
                                    <span style="font-size:18px; line-height:1.4;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            Hi <?php echo $host_name;?>, you have declined <?php echo $client_fname;?>s booking request for <?php echo $room_name;?> (<?php echo $venue_name;?>).
                                            <br>
                                            <br>
                                            Our team are now searching for alternative venues for the requester. If you have any questions please contact Zipcube on +44 (0)20 7183 2212 or email <a href="mailto:info@zipcube.com">info@zipcube.com</a>.
                                        </span>
                                    </span>
                                </span>
                                <br>
