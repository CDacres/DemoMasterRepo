                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            <strong>
                                                <span style="color:#484848;">Demande de réservation refusée!</span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="color:#484848;">
                                    <span style="font-size:18px; line-height:1.4;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            Salut <?php echo $host_name;?>, vous avez décliné <?php echo $client_fname;?>s la demande de réservation pour <?php echo $room_name;?> (<?php echo $venue_name;?>).
                                            <br>
                                            <br>
                                            Notre équipe est maintenant à la recherche d'autres lieux pour le demandeur. Si vous avez des questions, veuillez contacter Zipcube au +33 9 74 59 20 00 ou par email <a href="mailto:info@zipcube.com">info@zipcube.com</a>.
                                        </span>
                                    </span>
                                </span>
                                <br>
