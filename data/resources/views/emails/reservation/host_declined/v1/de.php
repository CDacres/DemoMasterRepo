                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            <strong>
                                                <span style="color:#484848;">Reservierungsanfrage abgelehent!</span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="color:#484848;">
                                    <span style="font-size:18px; line-height:1.4;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            Hallo <?php echo $host_name;?>, Sie haben abgelehnt <?php echo $client_fname;?>s Buchungsanfrage für <?php echo $room_name;?> (<?php echo $venue_name;?>).
                                            <br>
                                            <br>
                                            Unser Team ist gerade auf der Suche nach alternativen Veranstaltungsortenfür den Kunden. Für weitere Fragen, bitte rufen Sie uns an +49 (0)3221 1121730 oder schicken Sie uns eine E-Mail an email <a href="mailto:info@zipcube.com">info@zipcube.com</a>.
                                        </span>
                                    </span>
                                </span>
                                <br>
