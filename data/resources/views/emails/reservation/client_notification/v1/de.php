                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            <strong>
                                                <span style="color:#484848;">Buchungsanfrage geschickt!</span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="color:#484848;">
                                    <span style="font-size:18px; line-height:1.4;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            Hallo <?php echo $client_fname;?>, Ihre Buchungsanfrage wurde erfolgreich geschickt an <?php echo $venue_name;?>.
                                            <br>
                                            <br>
                                            Wir haben den gesamten Buchungsbeträg auf Ihrer Keditkarte reserviert, ohne diesen jedoch gleich abzubuchen (Vorautorisierung). Wir buchen den Gesamtbetrag ab, erst nachdem Ihre Reservierung bestätigt wurde. Falls der Anbieter Ihre Reservierung ablehnt, stornieren wir die Vorautorisierung. In diesem Fall wird Zipcube Ihnen alternativen Räumlichkeite schicken.
                                            <br>
                                            <br>
                                            Mehr als 50% der Buchungsanfragen erhalten eine positive Antwort innerhalb von einer Stunde.
                                        </span>
                                    </span>
                                </span>
                                <br>
                        ...
                        <tr>
                            <td class="mcnButtonContent" style="font-family:'Helvetica Neue', Helvetica, Arial, Verdana, sans-serif; font-size:16px; padding:15px;" valign="middle" align="center">
                                <?php
                                    ...
                                    {
                                ?>
                                        <a class="mcnButton" title="Erstellen Sie Ihr Passwort!" href="<?php echo $set_password_link;?>" target="_blank" style="font-weight:normal; letter-spacing:normal; line-height:100%; text-align:center; text-decoration:none; color:#FFFFFF;">Erstellen Sie Ihr Passwort!</a>
                                        <?php
                                    }
                                    else
                                    {
