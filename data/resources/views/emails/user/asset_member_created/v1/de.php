                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                ...
                                <span style="color:#484848;">
                                    <span style="font-size:18px; line-height:1.4;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            <?php echo $asset_name;?> benutzen Zipcube um ihre Räumlichkeiten zu verwalten und haben ein Konto für Sie erstellt, so dass Sie ihre Räume online buchen können. Bitte
                                            <?php
                                                if ($action == 'token')
                                                {
                                                    echo ' <a href="' . $set_password_link . '">aktivieren Sie Ihr Konto jetzt</a> um auf Ihr Konto zuzugreifen und Ihr Passwort zu aktualisieren.';
                                                }
                                                else
                                                {
                                                    echo ' <a href="' . $login_link . '">aktivieren Sie Ihr Konto jetzt</a> um auf Ihre exklusive Preise zuzugreifen und Ihr Passwort zu aktualisieren.';
                                                }
                                            ?>
                                        </span>
                                    </span>
                                ...
                                <span style="font-size:18px;">
                                    <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                        ...
                                        <br>
                                        <br>
                                        - Buchen <?php echo $asset_name;?> Meetingräume mit <a href="<?php echo $widget_link;?>">ihre Microsite</a>
                                        <br>
                                        <br>
                                        - Sehen Sie sich Ihre bevorstehenden Buchungen und Rechnungen
                                        <br>
                                        <br>
                                        - Positive Bewertung abgeben <?php echo $asset_name;?>
                                        <br>
                                        <br>
                                        Zipcubes Hauptziel ist es, Ihnen den schnellsten und bequemsten Weg zum gewünschten Meetingraum anzubieten. Falls Sie Zipcube für Ihr Büro benutzen möchten oder uns Ihr Feedback mitteilen möchten, wir würden gern mehr von Ihnen hören auf +49 (0)3221 1121730 oder per E-Mail auf <a href="mailto:info@zipcube.com">info@zipcube.com</a>.
                                    </span>
                                </span>
                                <br>
                                <br>
