                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                ...
                                <span style="color:#484848;">
                                    <span style="font-size:18px; line-height:1.4;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            <?php echo $asset_name;?> utilisent maintenant Zipcube pour gérer leurs salles de réunion et ont créé un compte pour vous afin que vous puissiez réserver leurs salles en ligne. S'il vous plaît
                                            <?php
                                                if ($action == 'token')
                                                {
                                                    echo ' <a href="' . $set_password_link . '">activez votre compte maintenant</a> pour accéder à votre tableau de bord de réservation et pour mettre à jour votre mot de passe.';
                                                }
                                                else
                                                {
                                                    echo ' <a href="' . $login_link . '">activez votre compte maintenant</a> pour accéder à votre tarif exclusif de réservation et pour mettre à jour votre mot de passe.';
                                                }
                                            ?>
                                        </span>
                                    </span>
                                ...
                                <span style="font-size:18px;">
                                    <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                        ...
                                        <br>
                                        <br>
                                        - Réserver <?php echo $asset_name;?> des salles de réunion en utilisant <a href="<?php echo $widget_link;?>">leurs Microsite</a>
                                        <br>
                                        <br>
                                        - Consultez vos prochaines réservations et accédez aux reçus de paiement
                                        <br>
                                        <br>
                                        - Laisser des commentaires positifs pour <?php echo $asset_name;?>
                                        <br>
                                        <br>
                                        La mission de Zipcube est de fournir le moyen le plus rapide, le plus simple et le plus commode de trouver et de réserver des salles de réunion. Si vous êtes intéressés à utiliser Zipcube pour votre bureau ou si vous avez des commentaires sur notre service, nous aimerions avoir de vos nouvelles au +33 9 74 59 20 00 ou par email <a href="mailto:info@zipcube.com">info@zipcube.com</a>.
                                    </span>
                                </span>
                                <br>
                                <br>
