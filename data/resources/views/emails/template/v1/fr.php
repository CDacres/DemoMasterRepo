...
<body leftmargin="0" topmargin="0" offset="0" marginwidth="0" marginheight="0">
    <center>
        <table id="bodyTable" height="100%" width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
            <tbody>
                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="mcnTextContent" style="padding:0px 18px 9px; color:#888888;" valign="top">
                                                                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                                                                            <span style="color:#D3D3D3;">Louez des salles de réunion avec </span>
                                                                                            <a href="https://www.zipcube.com/<?php echo $domain . $analytics_str;?>" target="_blank">
                                                                                                <span style="color:#D3D3D3;">Zipcube</span>
                                                                                            </a>
                                                                                        </span>
                                                                                    </td>
                                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td class="mcnTextBlockInner" style="padding-top:9px;" valign="top">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="mcnTextContent" style="padding-top:0; padding-left:18px; padding-bottom:9px; padding-right:18px;" valign="top">
                                                                                        <a href="https://www.zipcube.com/<?php echo $domain . $analytics_str;?>" target="_blank">
                                                                                            <img src="https://www.zipcube.com/css/images/logo/zipcube_email_logo.png" style="width:200px; height:50px; margin:0px;" height="50" width="200" align="none">
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        ...
                                                                        <table style="max-width:300px;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="mcnTextContent" style="padding-top:0; padding-left:18px; padding-bottom:9px; padding-right:18px;" valign="top"></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                    ...
                                                    <td class="bodyContainer" valign="top">
                                                        ...
                                                        <table class="mcnDividerBlock" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                            <tbody class="mcnDividerBlockOuter">
                                                                <tr>
                                                                    <td class="mcnDividerBlockInner" style="min-width:100%; padding:50px 18px 70px;">
                                                                                                                    ...
                                                                                                                    <td valign="top" align="left">
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td class="mcnFollowIconContent" style="padding-right:10px; padding-bottom:9px;" valign="top" align="center">
                                                                                                                                        <a href="https://www.facebook.com/Zipcube/?fref=ts" target="_blank">
                                                                                                                                            <img src="https://www.zipcube.com/css/images/logo/facebook_logo.png" alt="Facebook" class="mcnFollowBlockIcon" style="width:48px; max-width:48px; display:block;" width="48">
                                                                                                                                        </a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                        ...
                                                                                                                        <table class="mcnFollowStacked" style="display:inline;" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td class="mcnFollowIconContent" style="padding-right:10px; padding-bottom:9px;" valign="top" align="center">
                                                                                                                                        <a href="http://www.twitter.com/zipcube" target="_blank">
                                                                                                                                            <img src="https://www.zipcube.com/css/images/logo/twitter_logo.png" alt="Twitter" class="mcnFollowBlockIcon" style="width:48px; max-width:48px; display:block;" width="48">
                                                                                                                                        </a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr>
                                                                                                                                    <td class="mcnFollowIconContent" style="padding-right:0; padding-bottom:9px;" valign="top" align="center">
                                                                                                                                        <a href="https://www.zipcube.com/<?php echo $domain . $analytics_str;?>" target="_blank">
                                                                                                                                            <img src="https://www.zipcube.com/css/images/logo/zipcube_email_small_logo.png" alt="Zipcube" class="mcnFollowBlockIcon" style="width:48px; max-width:48px; display:block;" width="48">
                                                                                                                                        </a>
                                                                                                                                    </td>
                                                                                                                                </tr>
                                                                                                                            </tbody>
                                                                                    ...
                                                                                    <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                                        <div style="text-align:left;">
                                                                                            <span style="font-size:18px;">
                                                                                                <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                                                                                    Besoin d'aide? Appellez nos équipe au
                                                                                                    <strong>
                                                                                                        <a href="tel:+33 9 74 59 20 00">+33 9 74 59 20 00</a>
                                                                                                    </strong>
                                                                                                </span>
                                                                                            </span>
                                                                                        </div>
                                                            ...
                                                            <tbody class="mcnDividerBlockOuter">
                                                                <tr>
                                                                    <td class="mcnDividerBlockInner" style="min-width:100%; padding:18px;">
                                                                        <table class="mcnDividerContent" style="min-width:100%; border-top-width:1px; border-top-style:solid; border-top-color:#999999;" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <span></span>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                                        <em>
                                                                                            <a href="https://www.zipcube.com/<?php echo $domain . $analytics_str;?>" target="_blank">
                                                                                                <img src="https://www.zipcube.com/css/images/logo/search_logo.png" style="width:300px; height:38px; margin:0px;" height="38" width="300" align="none">
                                                                                            </a>
                                                                                            <br>
                                                                                            <br>
                                                                                            <br>
                                                                                            Droits d'auteur © <?php echo date("Y");?> Zipcube Ltd., Tous droits réservés.
                                                                                        </em>
                                                                                        &nbsp;
                                                                                    </td>
                                                                                </tr>
