                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                ...
                                <span style="font-size:18px;">
                                    <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                        <?php echo $reply_author;?> hat auf Ihre Bewertung geantwortet <?php echo $venue_name;?>:
                                        <br>
                                        <br>
                                        "<?php echo $reply;?>"
                                    </span>
                    ...
                    <tbody>
                        <tr>
                            <td class="mcnButtonContent" style="font-family:'Helvetica Neue', Helvetica, Arial, Verdana, sans-serif; font-size:16px; padding:15px;" valign="middle" align="center">
                                <a class="mcnButton" title="Sehen Sie sich die Antworten in Ihrem Konto an" href="<?php echo $review_page_link;?>" target="_blank" style="font-weight:normal; letter-spacing:normal; line-height:100%; text-align:center; text-decoration:none; color:#FFFFFF;">Sehen Sie sich die Antworten in Ihrem Konto an</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
