                        ...
                        <tr>
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px;">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                            <strong>
                                                <span style="color:#484848;">Your review has been published!</span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="font-size:18px;">
                                    <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif;">
                                        your review of <?php echo $venue_name;?> has been published.
                                        <?php
                                            if (isset($action) && $action == 'token')
                                            {
                                                echo '<br><br>By the way, you can set a password for your new Zipcube account so that you can take a look back at any reviews you have written.';
                                            }
                                        ?>
                                    </span>
                                </span>
