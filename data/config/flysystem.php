...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'deep_storage_local' => [
            'driver'     => 'local',
            'path'       => env('LOCAL_DEEP_STORAGE_PATH', storage_path('files') . '/deep_storage'),
            // 'visibility' => 'public',
            // 'pirate'     => false,
            // 'eventable'  => true,
            // 'cache'      => 'foo'
        ...
        'holding' => [
            'driver'     => 'local',
            'path'       => env('FILE_HOLDING_PATH', storage_path('files') . '/holding'),
            // 'visibility' => 'public',
            // 'pirate'     => false,
            // 'eventable'  => true,
            // 'cache'      => 'foo'
        ...
        'download' => [
            'driver'     => 'local',
            'path'       => env('LOCAL_FILE_DOWNLOAD_PATH', storage_path('downloads'))
        ],

        'asset_images_rax_cdn' => [
            'driver'     => 'rackspace',
            'endpoint'   => Rackspace::UK_IDENTITY_ENDPOINT,
            'region'     => env('RACKSPACE_REGION'),
            'username'   => env('RACKSPACE_API_USER'),
            'apiKey'     => env('RACKSPACE_API_KEY'),
            'container'  => env('RACKSPACE_STORAGE_ASSET_IMAGES_CONTAINER')
        ],
        ...
        'site_images_rax_cdn' => [
            ...
            'username'   => env('RACKSPACE_API_USER'),
            'apiKey'     => env('RACKSPACE_API_KEY'),
            'container'  => env('RACKSPACE_STORAGE_SITE_IMAGES_CONTAINER')
        ],

        'images_local' => [
            'driver'     => 'local',
            'path'       => env('IMAGES_PATH', storage_path('files') . '/images'),
        ],
        ...
        'deep_storage_rax' => [
            ...
            'username'   => env('RACKSPACE_API_USER'),
            'apiKey'     => env('RACKSPACE_API_KEY'),
            'container'  => env('RACKSPACE_STORAGE_DEEP_STORAGE_CONTAINER')
        ],

        'files' => [
            'driver'     => 'local',
            'path'       => env('IMAGES_PATH', storage_path('files') . '/menus'),
        ],
