/* global window document ga performance */
 ...
 */
const TRACKING_ID = 'UA-92430122-1';
...
const trackCustomDimensions = () => {
    ...
    ga((tracker) => {
        ...
        // console.log(`${dimensions.TRACKING_VERSION}: ${TRACKING_VERSION}`);
        // console.log(`${dimensions.CLIENT_ID}: ${tracker.get('clientId')}`);
        // console.log(`${dimensions.WINDOW_ID}: ${uuid()}`);
    });
...
export const init = () => {
    return new Promise((resolve) => {
        ...
        createTracker();
        trackErrors();
        const clientId = trackCustomDimensions();
        sendInitialPageview();
