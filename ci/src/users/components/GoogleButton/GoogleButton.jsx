...
function GoogleButton({ id, buttonText, customClass }) {
    return (
        <div className="form-social-button-wrapper">
            <button id={id} className={`form-social-button-google signup-login-form__btn icon-btn btn-large${customClass ? customClass : ''}`}>
                <span className="form-social-button-text-google">
                    <div className="form-social-button-text-container">
                        <svg className="icon icon-google-image" viewBox="0 0 18 18" aria-hidden="true" focusable="false" style={{ fill: 'currentcolor' }}>
                        ...
                        <div className="form-social-button-text-container-child">
                            <span id="google_button_text">{buttonText}</span>
                        </div>
                    </div>
                </span>
            </button>
