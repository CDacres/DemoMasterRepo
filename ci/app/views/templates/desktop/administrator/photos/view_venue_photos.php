            ...
            <div class="jumbotron">
                <div class="container-fluid container-fixed-lg">
                    <div class="inner">
                            ...
                            <div class="col-lg-9 col-md-9 col-sd-9">
                                <div class="panel panel-transparent">
                                    <div class="panel-body">
                                        <h4>Venue Images: <?php echo $num_results;?></h4>
                                        <?php
                                            if (isset($keyword))
                                            {
                                            ...
                                            {
                                                echo '<a href="' . site_url($country_lang_url . '/administrator/photos/venues/' . $buttonStatus) . '" class="btn admin-button ' . (($buttonStatus == $status)?'btn-success':'btn-default') . '">' . $buttonText . '</a>';
                                            }
                                        ?>
	            		...
	            		<form accept-charset="UTF-8" action="<?php echo site_url($country_lang_url . '/administrator/photos/venuekeyword');?>" method="post">
                                ...
                                <tr>
                                    <?php
                                        foreach ($fields as $field_name => $field_display)
                                        {
                                            ...
                                            {
                                                echo '<a href="/' . $country_lang_url . '/administrator/photos/' . ((isset($keyword))?'venuekeyword/' . $keyword:'venues/' . $status) . '/' . $field_name . '/' . (($sort_order == 'desc' && $sort_by == $field_name)?'asc':'desc') . '">' . $field_display;
                                        ...
                                        <tr class="text-left">
                                            ...
                                            <td width="10%">
                                                <a class="fancybox" rel="<?php echo $image->get_id();?>" href="<?php echo $url;?>">
                                                    <img src="<?php echo $url;?>" alt="<?php echo $image->wrangle('defaulted_venue_name')->value();?>" title="<?php echo $image->wrangle('defaulted_venue_name')->value();?>">
                                                </a>
                                            </td>
                                            <td width="5%">
