                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">
                                            <strong>
                                                <span style="color:#484848"><?php echo $lang->line('email_booking_declined');?></span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="color:#484848">
                                    <span style="font-size:18px; line-height:1.4">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif"><?php echo $lang->line('email_hi');?> {host_name}, <?php echo $lang->line('email_you_declined');?> {client_fname}<?php echo $lang->line('email_venue_booking_request');?> {room_name} ({venue_name}).<br><br><?php echo $lang->line('email_our_team');?></span>
                                    </span>
                                </span>
                                <br>
                                <br>
