                        ...
                        <tr>
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                ...
                                <span style="font-size:18px">
                                    <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">
                                        <?php echo $lang->line('email_hi');?> <?php echo $lang->line('email_admin');?>,<br><br> <?php echo $lang->line('email_you_have_new_message');?>
                                        <br>
                                        <br>
                                        <?php echo $lang->line('common_details');?>:
                                        <br>
                                        <br>
                                        <?php echo $lang->line('email_email');?> {email}
                                        <br>
                                        <?php echo $lang->line('email_name');?>: {name}
                                        <br>
                                        <?php echo $lang->line('email_message_cap');?>: {message}
                                    </span>
                                </span>
                                <br>
                                <br>
