                        ...
                        <tr>
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                <span style="font-size:18px">
                                    <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif"><?php echo $lang->line('email_no_reservation_contact');?> {reservation_id}<br><br><?php echo $lang->line('email_booking_taken_not_notified');?></span>
                                </span>
                                <br>
                                <br>
                                &nbsp;
