                        ...
                        <tr>
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">
                                            <strong>
                                                <span style="color:#484848"><?php echo $lang->line('email_reservation_accepted');?></span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="font-size:18px">
                                    <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">
                                        <?php echo $lang->line('email_hi');?> <?php echo $lang->line('email_admin');?>,<br><br> {host_name} <?php echo $lang->line('email_accepted');?> {client_fname} <?php echo $lang->line('email_reservation_space_request');?> "{room_name}" ({venue_name}).
                                        <br>
