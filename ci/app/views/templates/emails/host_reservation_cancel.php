                                        ...
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">
                                            <strong>
                                                <span style="color:#484848">
                                                    <?php
                                                        echo $lang->line('email_reservation_cancelled') . ' ' . $lang->line('email_by') . ' ';
                                                        if ($action == 'cancelbyclient')
                                                        {
                                                            echo $lang->line('email_client');
                                                        }
                                                        elseif ($action == 'cancelbyhost')
                                                        {
                                                            echo '{venue_name}';
                                                        }
                                                    ?>
                                    ...
                                    <span style="font-size:18px; line-height:1.4">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">
                                            <?php
                                                if ($action == 'cancelbyclient')
                                                {
                                                    echo '{client_fname} ' . $lang->line('email_booking_cancelled_for') . ' {room_name} ({venue_name}).<br>' . $lang->line('email_administer') . ' {venue_name}' . $lang->line('email_page_at_booking_time') . '.';
                                                }
                                                elseif ($action == 'cancelbyhost')
                                                {
                                                    echo $lang->line('email_confirmed_booking') . ' "{room_name}" ' . $lang->line('email_in') . ' {venue_name} ' . $lang->line('email_has_been_cancelled');
                                                }
                                            ?>
                                        </span>
                                    </span>
