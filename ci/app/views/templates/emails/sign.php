                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">
                                            <strong>
                                                <span style="color:#484848"><?php echo $lang->line('email_welcome');?></span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="color:#484848">
                                    <span style="font-size:18px; line-height:1.4">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">
                                            <?php echo $lang->line('email_thank_you');?>
                                            <br>
                                            <?php echo $lang->line('email_with_zipcube');?>
                                            <br>
                                            <br>
                                            <i><?php echo $lang->line('email_feel_free');?></i>
                                        </span>
                                    </span>
                                </span>
                                <br>
                                ...
                                <h1>
                                    <span style="font-size:32px; line-height:1.3; max-width:485px">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">
                                            <strong>
                                                <span style="color:#484848"><?php echo $lang->line('email_account_details');?></span>
                                            </strong>
                                        </span>
                                    </span>
                                </h1>
                                ...
                                <span style="font-size:18px">
                                    <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif"><?php echo $lang->line('email_email_login');?> {email}</span>
                                </span>
                                <br>
                                <br>
                                &nbsp;
                        ...
                        <tr>
                            <td class="mcnButtonContent" style="font-family: 'Helvetica Neue', Helvetica, Arial, Verdana, sans-serif; font-size: 16px; padding: 15px;" valign="middle" align="center">
                                ...
                                ?>
                                    ...
                                    {
                                        ?>
                                        <a class="mcnButton" title="<?php echo $lang->line('email_start_search');?>" href="https://www.zipcube.com/{user_country_lang}<?php echo $analytics_str;?>" target="_blank" style="font-weight: normal;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;"><?php echo $lang->line('email_start_search');?></a>
                                        <?php
                                    }
                                        ?>
                            </td>
