                            ...
                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                            ...
                                            <strong>
                                                <span style="color:#484848">
                                                    <?php
                                                        if ($action == 'expire')
                                                        {
                                                            echo $lang->line('email_sorry_expired');
                                                        }
                                                        elseif ($action == 'declined')
                                                        {
                                                            echo $lang->line('email_sorry_declined');
                                                        }
                                                    ?>
                                                </span>
                                            </strong>
                                ...
                                <span style="color:#484848">
                                    <span style="font-size:18px; line-height:1.4">
                                        <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif">
                                            <?php
                                                echo $lang->line('email_hi') . ' {client_fname},<br>';
                                                if ($action == 'expire')
                                                {
                                                    echo $lang->line('email_your_booking_request') . ' {venue_name} ' . $lang->line('email_has_expired') . '.<br><br>' . $lang->line('email_apologise') . '<br>' . $lang->line('email_payment_voided');
                                                }
                                                elseif ($action == 'declined')
                                                {
                                                    echo $lang->line('email_your_booking_request') . ' "{room_name}" ' . $lang->line('email_was_declined') . ' {venue_name}.<br><br>' . $lang->line('email_apologise') . '<br>' . $lang->line('email_payment_voided') . ' <br><br>{venue_name} ' . $lang->line('email_message') . ' (optional): <i>{comment}</i>';
                                                }
                                            ?>
                                        </span>
                                    </span>
                                ...
                                <span style="font-size:18px">
                                    <span style="font-family:helvetica neue,helvetica,arial,verdana,sans-serif"><?php echo $lang->line('email_alternatively');?></span>
                                </span>
                                <br>
                                <br>
                                &nbsp;
