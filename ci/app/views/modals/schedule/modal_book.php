<form>
    <input type="hidden" id="zc_bt_client_token" value="<?php echo $bt_client_token;?>">
    <input type="hidden" id="braintree_nonce">
    <div class="row">
        <div class="col-md-12">
            <h5 id="title"><?php echo $lang->line('modals_booking_client');?></h5>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <h5 id="title"><?php echo $lang->line('payments_index_sidebar_booking_details_heading');?></h5>
        </div>
    </div>
    <div class="form-group space-top-2 bottom-p-1 separator-dotted">
        <div class="row">
