<form>
    ...
    ?>
            <div class="row">
                <div class="col-md-12">
                    <h5 id="title">
                        <span id="sign-in" class="no-link"><?php echo $lang->line('modals_enquiry_signin_request');?></span>
                    </h5>
                </div>
            </div>
            <?php
    ...
    <div class="form-group space-top-2 bottom-p-1">
        ...
        ?>
                <div class="row">
                    <div class="col-sm-3">
                        <label class="control-label" for="eventDate"><?php echo $lang->line('modals_enquiry_move_in');?><span class="required">*</span></label>
                    ...
                    <div class="col-sm-4">
                        <label class="control-label" for="duration"><?php echo $lang->line('common_duration');?><span class="required">*</span></label>
                    ...
                    <div class="col-sm-2">
                        <label class="control-label" for="deskCount"><?php echo $lang->line('Desks');?><span class="required">*</span></label>
                        <div class="select select-block">
            ...
            else
            {
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <label class="control-label" for="eventDate"><?php echo $lang->line('common_date');?><span class="required">*</span></label>
                        <div id="calendar_icon_container">
                            <span id="calendar-icon" class="glyphicon glyphicon-calendar" aria-hidden="true"></span>
                            <input id="eventDate" class="datepicker form-control" name="eventDate" type="text" placeholder="<?php echo $lang->line('modals_enquiry_select_date');?>" autocomplete="off" />
                        </div>
                    ...
                    <div class="col-sm-4">
                        <label class="control-label" for="eventTime"><?php echo $lang->line('common_time');?><span class="required">*</span></label>
                        <div class="select select-block">
