...
class Paypal_Lib {
	...
	function __construct()
	{
		...
		$this->add_field('paymentaction','authorization');
		$this->button('Pay Now!');
	}
	...
	function paypal_auto_form()
	{
		...
		echo '<body style="font-size: 80%;background-color: #f5f7fa;margin: 0;padding: 0;font: normal 11px Arial;text-align: center;color: #767676;" onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
		echo '<div style="padding: 20px; width: 960px; left: 25%; top: 25%; position: absolute; border: 1px solid #DFDFDF; color: #4579AA; background: #FFFFFF;">' . "\n";
		echo '<h1><img src="https://www.zipcube.com/css/images/logo/zipcubelogo.png" alt="Zipcube.com" title="Zipcube.com"></h1>
		<p>Please wait, your order is being processed and you will be redirected to the paypal website.</p>' . "\n";
		echo '<img src="https://www.zipcube.com/css/images/common/7.gif" alt="Zipcube.com" title="Zipcube.com">' . "\n";
