...
class Twitter {
	...
	public function get_MailId($twit_id) {
        
			$this->db->select('email','twitter_id','username');
			$this->db->where('twitter_id', $twit_id);
   	...
   	public function first_last_name($twitter_id)
	{
	   $trends_url = "http://api.twitter.com/1/users/show.json?user_id=".$twitter_id."&include_entities=true";
					...
					$first_last_name = $response['name'];
			
//			echo $image_url;
			return str_replace("_normal","",$first_last_name);
	...
	public function profileinfo ($twitter_id,$twitter_name = 0)
	{
	//	$content = 'coming';
	 if($twitter_name)
	 {
		$trends_url = "http://api.twitter.com/1/users/show.json?screen_name=".$twitter_name."&include_entities=true";
	 }
	 if($twitter_id)
	 {
	  $trends_url = "http://api.twitter.com/1/users/show.json?user_id=".$twitter_id."&include_entities=true";
	...
	public function profile_image($twitter_id)
	{
	   $trends_url = "http://api.twitter.com/1/users/show.json?user_id=".$twitter_id."&include_entities=true";
...
//			echo $image_url;
			return str_replace("_normal","",$image_url);
	...
	public function profile_image_small($twitter_id)
	{
	 $trends_url = "http://api.twitter.com/1/users/show.json?user_id=".$twitter_id."&include_entities=true";
