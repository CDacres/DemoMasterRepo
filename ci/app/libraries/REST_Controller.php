...
class REST_Controller extends MY_Controller {
	...
	{
		parent::__construct();
                $this->lang->load('common', $this->session->userdata('user_lang'));
                $this->lang->load('rest', $this->session->userdata('user_lang'));
		...
		$this->load->library('security');
                $this->session->set_userdata('rest_authentication', TRUE);
		...
		if ( $this->auth_override !== TRUE )
		{
			...
			elseif ($this->config->item('rest_auth') == 'digest')
			{
				$this->_prepare_digest_auth();
                        ...
                        elseif ($this->config->item('rest_auth') == 'session')
                        {
