...
<Reverse bidding system>
    Copyright (C) <2009>  <Zipcube Technologies>
    ...
    If you want more information, please email me at bala.k@zipcube.com or
    contact us from www.zipcube.com/contact
...

{
 ...
 function SaveImage($im, $filename,$image_type,$save_to_file,$quality) {
  ...
  function GenerateThumbFile($from_name, $to_name,$n_wid,$n_hgt) {
    ...
    // Check size and compress regarding size
    $kb_size = filesize($from_name);
    if ($kb_size > 1000000) {
      $quality = 75;
    }
    elseif ($kb_size < 1000000 AND $kb_size > 100000) {
      $quality = 85;
    }
    else {
      $quality = 90;
