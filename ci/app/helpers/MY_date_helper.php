...
if(!function_exists('get_user_times'))
{
	...
	function get_user_times($gmt_time = '',$time_zone = '', $day_light = FALSE)
	{
		...
		return date('d F, Y',gmt_to_local($gmt_time, $time_zone, $day_light));


	}
}
if(!function_exists('get_user_hours'))
{

	function get_user_hours($gmt_time = '',$time_zone = '', $day_light = FALSE)
	{

		return date('h:i:s A',gmt_to_local($gmt_time, $time_zone, $day_light));
...
if ( ! function_exists('timezone_name'))
{
	function timezone_name($default = 'UTC', $class = "", $name = 'timezones')
	{
		...
		$CI->lang->load('date', config_item('language_code'));
